...
export const JOBS_TIER3: Tier3JobDef[] = [
  {
    ...
    description: [
      ...
      "**Смена:** **45–55k** ₽ плюс надбавки от ранга/стрика; **3%** шанс **служебного штрафа**. Коэффициент к выплате по номеру смены за **текущие календарные сутки** — в **Подробнее**.",
...
/** Обновление стрика за текущий календарный день (вызов ровно один раз в сутки на пользователя). */
