...
export interface EconomyUser {
  ...
  /** Баланс симки (пополнение в магазине); у курьера с него списывается окно «онлайн 24 ч», не основной счёт. */
  simBalanceRub?: number;
  /** До какого момента оплачено окно онлайн курьера (+24 ч) после последнего списания с баланса сим. */
