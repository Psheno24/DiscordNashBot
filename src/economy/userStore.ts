...
export interface EconomyUser {
  ...
  /** Баланс симки (пополнение в магазине); у курьера с него списывается тариф «онлайн 24 ч», не основной счёт. */
  simBalanceRub?: number;
  /** До какого момента оплачен тариф онлайн курьера (+24 ч) после последнего списания с баланса сим. */
