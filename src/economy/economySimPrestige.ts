...
export function simPrestigeRulesTableLines(): string[] {
  return [
    "`Источник` | `Очки`",
    "`Код 9XX` все 9 | `+300`",
    "`Середина XXX` все 9 | `+320`",
    "`Конец XX-XX` все 9 | `+380`",
    "`Середина XXX` тройка 999 | `+280`",
    "`Середина XXX` тройка не 9 | `+200`",
    "`Конец XX-XX` четыре подряд 9 | `+300`",
    "`Конец XX-XX` четыре подряд не 9 | `+220`",
    "`Середина XXX` зеркало | `+120`",
    "`Конец XX-XX` палиндром/зеркало | `+140..150`",
    "`Любой блок` три подряд | `+130..180`",
    "`Конец XX-XX` лестница | `+150`",
    "`Блок` просто повтор | `+55`",
    "`Блок` двойной ноль | `+40`",
    "`Весь номер` все 9 | `+900`",
    "`Весь номер` все одинаковые | `+520`",
    "`Весь номер` 8-9 девяток | `+620`",
    "`Весь номер` 6-7 девяток | `+380`",
    "`Весь номер` палиндром | `+320`",
    "`Весь номер` ритм ABAB... | `+340`",
    "`Весь номер` повтор фрагмента | `+300`",
    "`Весь номер` серия 5-6 подряд | `+220..400`",
    "`Весь номер` доминирует цифра | `+180..280`",
    "`Весь номер` лестница | `+260`",
    "`Весь номер` пары по шаблону | `+200`",
    "`Весь номер` эхо блоков | `+160`",
    "`Множители` комбинируются | `×1.18..×1.45`",
  ];
}
