...
const TITLES: Record<Tier12JobId, [string, string, string, string, string]> = {
  ...
  waiter: ["Помощник брокера", "Посредник", "Опытный посредник", "Куратор сделок", "Ведущий по связям"],
  ...
  expediter: ["Помощник зоны", "Оператор площадки", "Старший оператор", "Координатор смены", "Управляющий площадкой"],
};
